...
import com.ironoid.experiment.PAIDatabase.Unit1;
import com.ironoid.experiment.PAIDatabase.Unit2;
import com.ironoid.experiment.PAIDatabase.Unit3;
import com.ironoid.experiment.PAIDatabase.Unit4;
                    ...
                    public void onClick(View v) {
                     try{
                        ...
                        if (qid < totalq) {
                            ...
                            if(pref.getInt("pai_unit1_best_score",0) < score)
                            {
                                pref.edit().putInt("pai_unit1_best_score", score).apply();
                            }
                            d.cancel();
                            d.dismiss();
                    ...
                    public void onClick(View v) {
                     try{
                        ...
                        if (qid < totalq) {
                            ...
                            if(pref.getInt("pai_unit2_best_score",0) < score)
                            {
                                pref.edit().putInt("pai_unit2_best_score", score).apply();
                            }
                            d.cancel();
                            d.dismiss();
                            final Dialog d2 = new Dialog(getActivity(), android.R.style.Theme_Material_NoActionBar);
                    ...
                    public void onClick(View v) {
                     try{
                        ...
                        if (qid < totalq) {
                            ...
                            if(pref.getInt("pai_unit3_best_score",0) < score)
                            {
                                pref.edit().putInt("pai_unit3_best_score", score).apply();
                            }
                            d.cancel();
                            d.dismiss();
                            final Dialog d2 = new Dialog(getActivity(), android.R.style.Theme_Material_NoActionBar);
                    ...
                    public void onClick(View v) {
                     try{
                        ...
                        if (qid < totalq) {
                            ...
                            if(pref.getInt("pai_unit4_best_score",0) < score)
                            {
                                pref.edit().putInt("pai_unit4_best_score", score).apply();
                            }
                            d.cancel();
                            d.dismiss();
                            final Dialog d2 = new Dialog(getActivity(), android.R.style.Theme_Material_NoActionBar);
