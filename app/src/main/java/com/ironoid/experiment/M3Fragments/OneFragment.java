...
import com.ironoid.experiment.M3Database.Unit1;
import com.ironoid.experiment.M3Database.Unit2;
import com.ironoid.experiment.M3Database.Unit3;
import com.ironoid.experiment.M3Database.Unit4;
                    ...
                    public void onClick(View v) {
                     try{
                        ...
                        if (qid < totalq) {
                            ...
                            if(pref.getInt("m3_unit1_best_score",0) < score)
                            {
                                pref.edit().putInt("m3_unit1_best_score", score).apply();
                            }
                            d.cancel();
                            d.dismiss();
                    ...
                    public void onClick(View v) {
                     try{
                        ...
                        grp.clearCheck();
                            ...
                            if(pref.getInt("m3_unit2_best_score",0) < score)
                            {
                                pref.edit().putInt("m3_unit2_best_score", score).apply();
                            }
                            d.cancel();
                            d.dismiss();
                            final Dialog d2 = new Dialog(getActivity(), android.R.style.Theme_Material_NoActionBar);
                    ...
                    public void onClick(View v) {
                     try{
                        ...
                        if (qid < totalq) {
                            ...
                            if(pref.getInt("m3_unit3_best_score",0) < score)
                            {
                                pref.edit().putInt("m3_unit3_best_score", score).apply();
                            }
                            d.cancel();
                            d.dismiss();
                            final Dialog d2 = new Dialog(getActivity(), android.R.style.Theme_Material_NoActionBar);
                    ...
                    public void onClick(View v) {
                     try{
                        ...
                        if (qid < totalq) {
                            ...
                            if(pref.getInt("m3_unit4_best_score",0) < score)
                            {
                                pref.edit().putInt("m3_unit4_best_score", score).apply();
                            }
                            d.cancel();
                            d.dismiss();
                            final Dialog d2 = new Dialog(getActivity(), android.R.style.Theme_Material_NoActionBar);
