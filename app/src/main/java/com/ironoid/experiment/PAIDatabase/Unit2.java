package com.ironoid.experiment.PAIDatabase;
...
public class Unit2 extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;
    // Database Name
    private static final String DATABASE_NAME = "paiunit2";
    // tasks table name
    ...
    private void addQuestions()
    {
        Question q1=new Question("1. Which of the following data structure is" +
                "  non-linear type?","Tree", "PAI 2", "CISCO", "DELL", "CISCO");
        this.addQuestion(q1);
